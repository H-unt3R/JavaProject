...
public class SiteTableModel extends AbstractTableModel {
    ...
    public SiteTableModel() {
        ...
        try {
            Scanner input = new Scanner(new File("C:\\Users\\21431\\Documents\\NetBeansProjects\\JavaApplication5\\src\\sitedatabase.db"));
        ...
        data = new Object[site.size()][6];

        for (int i = 0; i < site.size(); i++) {
            data[i][0] = site.get(i).getAddress();
            data[i][1] = site.get(i).getSiteType().getTypeName();
    ...
    public boolean saveToDB() {
        ...
        try {
            File file = new File("C:\\Users\\21431\\Documents\\NetBeansProjects\\JavaApplication5\\src\\sitedatabase.db");
    ...
    public void removeSite(int rowId) {
        Object[][] newData = new Object[data.length - 1][5];
        int s = 0;
        for (int i = 0; i < data.length; i++) {
            if (i != rowId) {
                newData[s][0] = data[i][0];
                newData[s][1] = data[i][1];
                newData[s][2] = data[i][2];
                s++;
            }
            data = newData;
        }
